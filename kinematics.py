...
def main():
    ...
    # Creating sphere that will represent the joint between link1 and link 2
	joint_radius = 0.4
	jointSphere = Sphere(r=joint_radius).pos(L1 + joint_radius, 0, 0).color("grey").alpha(.8)  
    
	# Transform the joint sphere to psoition it at its correct location
	jointSphere.apply_transform(T_01)
	...
	# Combine all parts into a single object 
	Frame2 =  jointSphere + Frame2Arrows + link2_mesh
